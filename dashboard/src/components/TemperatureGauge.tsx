...
export default function TemperatureGauge({
  ...
  // Calculate threshold positions on the gauge (clamped to 0-1)
    ...
    <div className={`flex flex-col items-center ${getStatusClass()} gauge-container`}>
      <div className="relative w-36 h-28 sm:w-48 sm:h-40">
        ...
        >
          ...
          {/* Value arc - FIXED: use dasharray to define fill length from start */}
          <path
            d="M 20 130 A 80 80 0 1 1 180 130"
            fill="none"
            ...
            strokeWidth="12"
            strokeLinecap="round"
            strokeDasharray={`${arcLength * normalizedValue} ${arcLength}`}
            strokeDashoffset={0}
