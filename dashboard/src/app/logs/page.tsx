...
export default function LogsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <h1 className="text-base sm:text-xl font-bold text-gray-900 dark:text-white">Device Logs</h1>
            </div>
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2 py-1.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded text-gray-900 dark:text-white text-sm focus:outline-none focus:border-primary-500"
              >
      ...
      <div className="bg-gray-100 dark:bg-gray-900/30 border-b border-gray-200 dark:border-gray-800 px-3 sm:px-6 py-2">
        <div className="max-w-7xl mx-auto flex items-center justify-between text-xs text-gray-600 dark:text-gray-500">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2">
          {loading ? (
            ...
            <div className="text-center py-20 text-gray-500 dark:text-gray-500">
              ...
              <p className="text-xs mt-1 text-gray-400">Logs will appear here when the device sends them</p>
            </div>
          ) : (
            <div className="space-y-0.5">
              {logs.map((log, index) => (
                <div
                  key={log.id || index}
                  className={`flex items-start gap-2 py-1 px-2 rounded hover:bg-gray-200/50 dark:hover:bg-gray-800/50 ${
                    log.level === 'ERROR' ? 'bg-red-100 dark:bg-red-950/20' : ''
                  }`}
                >
                  <span className="text-gray-500 dark:text-gray-600 whitespace-nowrap text-xs">
